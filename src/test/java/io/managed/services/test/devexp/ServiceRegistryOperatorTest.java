...
public class ServiceRegistryOperatorTest extends TestBase {
    ...
    private final static String SERVICE_ACCOUNT_NAME = "mk-e2e-bo-sa-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
    ...
    private static final String SERVICE_REGISTRY_NAME = "mk-e2e-operator-sr-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
