...
public class KafkaMgmtAPITest extends TestBase {
    ...
    static final String SERVICE_ACCOUNT_NAME_FOR_DELETION = "mk-e2e-sa-delete" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
    static final String KAFKA_INSTANCE_NAME = "mk-e2e-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
    static final String SERVICE_ACCOUNT_NAME = "mk-e2e-sa-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
