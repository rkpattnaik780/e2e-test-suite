...
public class RegistryKafkaIntegrationTest extends TestBase {
    ...
    private static final String KAFKA_INSTANCE_NAME = "mk-e2e-ki-rki-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
    private static final String SERVICE_REGISTRY_NAME = "mk-e2e-sr-rki-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
    private static final String SERVICE_ACCOUNT_NAME = "mk-e2e-sa-rki-" + Environment.LAUNCH_KEY + Environment.CLOUD_PROVIDER;
